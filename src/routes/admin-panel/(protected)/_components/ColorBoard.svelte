...
<div class="flex w-full flex-col gap-3">
    ...
    <div
        bind:this={block}
        class="relative h-35 w-full shadow-[0_1px_3px_rgba(0,0,0,0.2)]"
    ...
    >
        <div
            ...
            class="absolute -mt-2 -ml-2 h-4 w-4 rounded-full border-2 border-white shadow-[0_1px_3px_rgba(0,0,0,0.2)] focus:outline-none"
    ...
    >
        <div
            ...
            aria-valuemin={0}
            aria-valuemax={359}
            class="absolute -top-1 -ml-1.75 h-3.5 w-3.5 rounded-full border-2 border-white shadow-[0_1px_3px_rgba(0,0,0,0.2)] focus:outline-none"
