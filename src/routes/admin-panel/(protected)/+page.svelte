<script lang="ts">
    import { FileTextIcon, FolderGit2Icon, VideoIcon } from "lucide-svelte/icons";
    ...
    const METRICS = $derived([
        ...
        { title: t.statVideos, icon: VideoIcon, value: 384, trend: -8.2 },
        { title: t.statProjects, icon: FolderGit2Icon, value: 47, trend: 8 }
    ]);
