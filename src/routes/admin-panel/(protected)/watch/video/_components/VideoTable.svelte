<script lang="ts">
    ...
    let { t, items, search, onView, onArchive, onUnarchive, onDelete }: Props = $props();
...
<div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
    <div
        class="hidden grid-cols-[72px_1fr_160px_120px_90px_110px_170px] items-center gap-4 border-b border-gray-100 bg-gray-50 px-5 py-3 text-xs font-semibold text-gray-500 uppercase md:grid"
    >
        <span></span>
