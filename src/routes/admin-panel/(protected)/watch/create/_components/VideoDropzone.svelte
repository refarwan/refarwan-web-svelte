<script lang="ts">
    import { ArrowUpIcon, FilmIcon, XIcon } from "lucide-svelte/icons";
    interface Props {
...
<div class="space-y-1.5">
    ...
    {:else}
        <div
            ...
            class={`flex cursor-pointer flex-col items-center justify-center gap-3 rounded-lg border border-dashed p-10 text-center transition-all ${
                isDragging
        ...
        >
            ...
            >
                <ArrowUpIcon class="stroke-2.5 h-4.5 w-4.5" />
            </div>
            <div>
