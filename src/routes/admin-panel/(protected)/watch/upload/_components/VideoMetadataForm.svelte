...
<div class="w-full flex-1 space-y-5">
	<div class="space-y-1.5">
		<label class="block text-sm font-medium text-gray-700" for="video-title">{t.titleLabel}</label>
		<input
			id="video-title"
			type="text"
			value={title}
	...
	<div class="space-y-1.5">
		...
		<textarea
			...
			class="min-h-25 w-full resize-y rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-2xs transition-all placeholder:text-gray-400 focus:border-theme-500 focus:ring-1 focus:ring-theme-500 focus:outline-none"
		></textarea>
	</div>
