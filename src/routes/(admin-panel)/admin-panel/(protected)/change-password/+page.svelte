        ...
        <form onsubmit={handleSubmit} class="space-y-4">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative flex items-center">
                    <input
                        ...
                        class={`w-full rounded-md border bg-white px-3.5 py-2.5 pr-11 text-sm text-gray-900 transition-colors placeholder:text-gray-400 focus:ring-2 focus:outline-none disabled:bg-gray-50 disabled:text-gray-400 ${fieldError("oldPassword") ? "border-red-400 focus:border-red-500 focus:ring-red-200" : "border-gray-300 focus:border-theme-600 focus:ring-theme-100"}`}
                    />
                    <button
                        type="button"
                    ...
                    >
                        {#if showOld}<Icon icon="lucide:eye-off" class="h-5 w-5" />{:else}<Icon
                                icon="lucide:eye"
                                class="h-5 w-5"
                            />{/if}
                    </button>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative flex items-center">
                    <input
                        ...
                        class={`w-full rounded-md border bg-white px-3.5 py-2.5 pr-11 text-sm text-gray-900 transition-colors placeholder:text-gray-400 focus:ring-2 focus:outline-none disabled:bg-gray-50 disabled:text-gray-400 ${fieldError("newPassword") ? "border-red-400 focus:border-red-500 focus:ring-red-200" : "border-gray-300 focus:border-theme-600 focus:ring-theme-100"}`}
                    />
                    <button
                        type="button"
                        ...
                        class="absolute right-3.5 flex items-center justify-center text-gray-400 transition-colors hover:text-gray-600"
                    >
                        {#if showNew}<Icon icon="lucide:eye-off" class="h-5 w-5" />{:else}<Icon
                                icon="lucide:eye"
                                class="h-5 w-5"
                            />{/if}
                    </button>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative flex items-center">
                    <input
                        ...
                        class={`w-full rounded-md border bg-white px-3.5 py-2.5 pr-11 text-sm text-gray-900 transition-colors placeholder:text-gray-400 focus:ring-2 focus:outline-none disabled:bg-gray-50 disabled:text-gray-400 ${fieldError("confirmPassword") ? "border-red-400 focus:border-red-500 focus:ring-red-200" : "border-gray-300 focus:border-theme-600 focus:ring-theme-100"}`}
                    />
                    <button
                        type="button"
                        ...
                        class="absolute right-3.5 flex items-center justify-center text-gray-400 transition-colors hover:text-gray-600"
                    >
                        {#if showConfirm}<Icon icon="lucide:eye-off" class="h-5 w-5" />{:else}<Icon
                                icon="lucide:eye"
                                class="h-5 w-5"
                            />{/if}
                    </button>
            ...
            <div class="pt-1">
                <button
                    type="submit"
                    disabled={submitting}
                    class="rounded-md bg-theme-600 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-theme-700 focus:ring-2 focus:ring-theme-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                >
