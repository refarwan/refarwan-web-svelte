<script lang="ts">
    ...
    const watchUrl = $derived(`${page.url.origin}/watch/play?v=${video.id}` as ResolvedPathname);
...
<div
    class="flex h-auto max-h-[90vh] w-[94vw] max-w-89.5 flex-col overflow-hidden rounded-xl bg-white sm:max-w-125 md:h-175 md:max-w-150"
    role="dialog"
    aria-modal="true"
>
    ...
    >
        ...
        <!-- Svelte Video Player -->
        <div class="relative aspect-video w-full shrink-0 overflow-hidden rounded-lg bg-black">
