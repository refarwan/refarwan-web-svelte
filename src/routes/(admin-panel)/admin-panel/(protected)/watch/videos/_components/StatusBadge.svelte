...
{:else}
    <span
        class={`inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium ${normalized === "archived" ? "border border-amber-200/60 bg-amber-50 text-amber-700" : "border border-gray-200 bg-gray-100 text-gray-700"} ${className}`}
    >
